...
void VideoViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onFinsihedDraw((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject VideoViewer::staticMetaObject = {
    { &QDeclarativeItem::staticMetaObject, qt_meta_stringdata_VideoViewer.data,
      qt_meta_data_VideoViewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VideoViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoViewer.stringdata))
        return static_cast<void*>(const_cast< VideoViewer*>(this));
