...
int main(int argc, char *argv[])
{
    ...
    VideoViewer* video_viewer = viewer.rootObject()->findChild<VideoViewer*>("mainView2");//to match video_viewer to obj mainView in qml file
//    mQmlViewer.rootObject()->findChild<QObject*>("mapviewer");
    ...
    //VideoViewer* video_viewer1 = viewer.rootObject()->findChild<VideoViewer*>("mainView3");//to match video_viewer to obj mainView in qml file
//    mQmlViewer.rootObject()->findChild<QObject*>("mapviewer");
...
//    VideoViewer* video_viewer2 = viewer.rootObject()->findChild<VideoViewer*>("mainView");//to match video_viewer to obj mainView in qml file
////    mQmlViewer.rootObject()->findChild<QObject*>("mapviewer");
...
//    VideoViewer* video_viewer3 = viewer.rootObject()->findChild<VideoViewer*>("mainView1");//to match video_viewer to obj mainView in qml file
////    mQmlViewer.rootObject()->findChild<QObject*>("mapviewer");
